...
//
//    	Furniture furniture = new Furniture(dto.idFurniture(),dto.name(), dto.price(), dto.description(), dto.sizeFurniture(), dto.environment(), dto.color(), dto.image(), woodworkSaved);
