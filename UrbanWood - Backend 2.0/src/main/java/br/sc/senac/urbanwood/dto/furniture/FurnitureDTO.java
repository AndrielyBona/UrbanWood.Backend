...
public record FurnitureDTO(Long idFurniture, String name, Double price,
						   String description, SizeFurniture sizeFurniture,
						   Environment environment, Color color, Image image, Woodwork id_woodwork) {
